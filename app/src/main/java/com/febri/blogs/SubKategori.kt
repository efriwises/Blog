...
class SubKategori : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?, persistentState: PersistableBundle?) {
        ...
        Toast.makeText(this@SubKategori, id.toString(), Toast.LENGTH_SHORT).show()
    ...
    inner class showData : AsyncTask<String, Void, String>() {
        ...
        override fun doInBackground(vararg params: String?): String {
            ...
            data?.put("id_kategori", id.toString())

            val result = data?.let { handler.sendPostRequest(Config.url_sub_kategori, it) }
            return result?: ""
        }
